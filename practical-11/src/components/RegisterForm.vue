    ...
    <div class="card-top">
      ...
      >
        ...
        <div class="form-group mb-2">
          ...
          <Field id="role" name="role" as="select" class="form-select" v-model="role">
        ...
        <div class="form-group mb-2">
          ...
          <Field id="dob" name="dob" type="date" :max="disableDate" class="form-control" v-model="dob"/>
...
export default {
  ...
  setup() {
    ...
    function handleSubmit() {
      ...
      store.dispatch('registerDetails',registerData);              
    }
